...
func (s *SugarAgentsRouter) InitSugarAgentsRouter(Router *gin.RouterGroup,PublicRouter *gin.RouterGroup) {
	...
	sugarAgentsRouterWithoutAuth := PublicRouter.Group("sugarAgents")
	{
	...
	{
	    sugarAgentsRouterWithoutAuth.GET("getSugarAgentsPublic", sugarAgentsApi.GetSugarAgentsPublic)  // sugar智能体表开放接口
	}
}
