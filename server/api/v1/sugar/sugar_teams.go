...
// @Param data body sugar.SugarTeams true "创建团队信息表"
...
func (sugarTeamsApi *SugarTeamsApi) CreateSugarTeams(c *gin.Context) {
	...
	var sugarTeams sugar.SugarTeams
	err := c.ShouldBindJSON(&sugarTeams)
	if err != nil {
...
func (sugarTeamsApi *SugarTeamsApi) DeleteSugarTeams(c *gin.Context) {
	...
	id := c.Query("id")
	err := sugarTeamsService.DeleteSugarTeams(ctx,id)
	if err != nil {
...
func (sugarTeamsApi *SugarTeamsApi) DeleteSugarTeamsByIds(c *gin.Context) {
	...
	err := sugarTeamsService.DeleteSugarTeamsByIds(ctx,ids)
	if err != nil {
...
// @Accept application/json
// @Produce application/json
// @Param data body sugar.SugarTeams true "更新团队信息表"
